+++
title = 'Getting Things Done - 5 Collection'
date = 2026-06-01T21:57:54-04:00
+++

## 5.1 Look for Open Loops
**Open loops** are what we are looking for:
- All incomplete items with features "should", "need to", or "ought to".
- Anything that is "pending", "in-progess", or "not-yet-finished".

We will move all open loops into an **in-basket**.

## 5.2 Warning
- Do NOT purge.
- Go for quantity.

## 5.3 Where to Find Open Loops?

This is a comprehensive checklist of where to find open loops.
...
Return to <a href = "/projects/gtd-main">Getting Things Done (GTD)</a>
